      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            A comprehensive program designed to support parents and strengthen family relationships 
            through evidence-based strategies and practical guidance.
          </p>
          ...
          {!canAccessModules && pendingScales.length > 0 && user?.role !== 'admin' && (
            <div className="bg-yellow-50 border-2 border-yellow-200 rounded-xl p-6 mb-8 max-w-2xl mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                Before accessing modules, please complete our initial assessment to help us 
                provide you with most relevant content and support.
              </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">10 Comprehensive Modules</h3>
            <p className="text-gray-600">
              From building connections to managing anxiety, each module provides practical strategies for common parenting challenges.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">Interactive Activities</h3>
            <p className="text-gray-600">
              Engage with quizzes, reflective exercises, and practical activities designed to reinforce learning.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">Personalized Support</h3>
            <p className="text-gray-600">
              Our assessment tools help tailor the content to your specific family needs and challenges.
            </p>
          </div>
        </div>
        ...
        {canAccessModules && user?.role !== 'admin' && (
          <div className="bg-white rounded-xl shadow-lg p-8 mb-16">
            <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Available Modules</h2>
        ...
        <div className="text-center text-gray-600">
          <p className="mb-2">
            A comprehensive parenting support program designed to help families thrive.
          </p>
          <p className="text-sm">
            © 2024 Partners in Parenting. All rights reserved.
          </p>
        </div>
      </div>
    </div>
